...
from hexgen_core.modules.mha import MHA, ParallelMHA
from hexgen_core.modules.mlp import Mlp, ParallelMLP, FusedMLP, ParallelFusedMLP
from hexgen_core.modules.mlp import GatedMlp, ParallelGatedMlp
from hexgen_core.modules.block import Block, ParallelBlock
from hexgen_core.modules.embedding import GPT2Embeddings, ParallelGPT2Embeddings
from flash_attn.utils.distributed import sync_shared_params, all_gather_raw
from flash_attn.utils.pretrained import state_dict_from_pretrained
from flash_attn.utils.generation import GenerationMixin
from hexgen_core.models.opt import remap_state_dict_hf_opt
from hexgen_core.models.gptj import remap_state_dict_hf_gptj
from hexgen_core.models.gpt_neox import remap_state_dict_hf_gpt_neox
from hexgen_core.models.falcon import remap_state_dict_hf_falcon
        ...
        for layer in self.layers:
            if self.prenorm:
                if not self.parallel_block:
                    hidden_states, residual, _ = layer(hidden_states, residual,
