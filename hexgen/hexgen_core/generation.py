...
def decode(input_ids, input_ids_shape, model, forward_step_func, max_length, pp_last_stage_rank,
    ...
    with torch.inference_mode():
        ...
        logits = model.gpipe_forward(forward_step_func, inputs, input_ids_shape, inference_params)[0]
        logits = logits[:,-1]
        ...
        while True:
            if torch.distributed.get_rank() == 0:
                print('Start computing seq <', inference_params.sequence_len_offset, '>')
