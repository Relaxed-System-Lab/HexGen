...
def evaluate(individual): 
    ...
    group_batch_list = []
    set_interval_for_global_search = 50
    ...
    if individual.iter % set_interval_for_global_search == 0:
        flattened_plan_list = [sublist for inner_list in group_plan_list for sublist in inner_list]
        simulator = Simulator(flattened_plan_list, individual.bias, individual.batch, slo=1.7) # In current impl, slo can be of any value.
